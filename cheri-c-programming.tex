...
% Keep Abstract in sync with the Introduction.
%
This document is a brief introduction to the pure-capability CHERI C/\cpp{}
...
\subsection{Pure-capability CHERI C/\cppInHeader{}}
...
CHERI pure-capability C/\cpp{} introduces a number of new types of protection not
...
Pure-capability CHERI C and \cpp{} implement pointers using architectural
...
Pure-capability CHERI C and \cpp{} also support automatically restricting the
...
In pure-capability CHERI C and \cpp{}, pointer comparison considers only the
