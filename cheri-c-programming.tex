...
It is important to use \ccode{alignof} instead of \ccode{sizeof} since GCC defines \maxalignt as a \ccode{struct} and not a \ccode{union}. Other
implementations including FreeBSD follow this pattern.} if pointers are to be stored in the allocation.
...
One use case \psnote{of what?}\arnote{capability bounds?} is high-performance applications that contain custom memory
