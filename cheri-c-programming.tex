...
The CHERI Clang compiler supports and experimental flag \texttt{-cheri-comparison=exact} that causes capability equality comparisons to also include capability metadata and the tag bits.
